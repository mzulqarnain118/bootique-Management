...
function Footer() {
  return (
    <Box component="footer" sx={{ py: 4, px: 2, mt: 'auto', backgroundColor: 'primary.main', color: 'white' }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap' }}>
        ...
        <Box sx={{ textAlign: 'center', mb: 2 }}>
          ...
          <Typography variant="body2">Address: 123 Ethnic St, Fashion City, Country</Typography>
